...
function Button(props) {
    ...
    return <Elm {...props} className={"py-[10px] px-[14px] rounded-[32px] bg-gradient-to-b from-[#0D67FE] to-[#0D67FE] font-[600] text-[16px] hover:from-[#fff] hover:to-[#ddd] hover:text-black disabled:cursor-not-allowed" + ' ' + props.className}>
