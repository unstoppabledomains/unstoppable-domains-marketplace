    ...
    return (
        <PageLayout>
            ...
            <Row className="justify-between items-center py-[24px]">
                ...
                <button className="flex  items-center gap-x-[8px] text-transparent bg-clip-text bg-gradient-to-b from-[#0D67FE] to-[#0D67FE] font-bold text-[14px] leading-[18px]" onClick={props.onCreateReivew}>
